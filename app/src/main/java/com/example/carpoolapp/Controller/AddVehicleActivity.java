...
import com.example.carpoolapp.Model.Users.User;
import com.example.carpoolapp.Model.Vehicle.Car;
import com.example.carpoolapp.Model.Vehicle.Helicopter;
import com.example.carpoolapp.Model.Vehicle.Bicycle;
import com.example.carpoolapp.Model.Vehicle.Segway;
...
public class AddVehicleActivity extends AppCompatActivity {
    ...
    private void setupSpinner() {  //add different users to spinner
    ...
    public void addFields() {
        ...
        if(selectedRole.equals("Bicycle")) {
            ...
            // maxAirSpeedEditText.setHint("airspeed");
            // maxAltitudeEditText = new EditText(this);
            maxAltitudeEditText.setHint("Max altitude");
            maxAirSpeedEditText = new EditText(this);
            maxAirSpeedEditText.setHint("Max airspeed");
    ...
    public void createVehicle(View v) {
        ...
        if(selectedRole.equals("Car")) {
            ...
            newVehicle = new Car(modelString, capacityInt, basePriceV, vehicleID,ownerId,range);
        }

        else if(selectedRole.equals("Segway")) {
            int weightCapacity = Integer.parseInt(weightCapacityEditText.getText().toString());
            int range = Integer.parseInt(rangeEditText.getText().toString());
            newVehicle = new Segway(modelString, capacityInt, basePriceV, vehicleID, ownerId, range, weightCapacity);
        }
            ...
            newVehicle = new Helicopter(modelString, capacityInt, basePriceV, vehicleID, ownerId, maxHeightInt, maxAirSpeedInt);
        }
            ...
            newVehicle = new Bicycle(modelString, capacityInt ,basePriceV, vehicleID, ownerId, bicycleType, weightInt, weightCapacityInt);
        }
        else{
            Toast.makeText(AddVehicleActivity.this,"Error", Toast.LENGTH_LONG).show();
        }
